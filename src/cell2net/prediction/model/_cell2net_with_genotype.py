...
from cell2net.prediction.module import PeaksTF2GeneExpressionPoissonWithGenotype
...
class Cell2NetWithGenotype(BaseModel):
    def __init__(
        self,
        mdata: MuData,
        gene: str,
    ...
    def _train(self) -> tuple[float, float, np.ndarray, np.ndarray]:
        ...
        for data in self.train_dl:
            ...
            # get prediction
            pred_exp = self.module(peak_seq1=peak_seq1,
                                   peak_seq2=peak_seq2,
                                   peak_acc=peak_acc,
                                   peak_dist=peak_dist,
                                   tf_exp=tf_exp,
