...
def check_if_adjustText():
    ...
    try:
        ...
        raise ImportError("adjustText is not installed. Please install it with: pip install adjustText") from None
    return at
...
def check_if_logomaker():
    ...
    try:
        ...
        raise ImportError("logomaker is not installed. Please install it with: pip install logomaker") from None
    return lm
