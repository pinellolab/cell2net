...
from cell2net.prediction.module import PeaksTF2GeneExpressionPoisson, PeaksTF2GeneExpressionPoisson_Jc
...
class Cell2Net_Jc(BaseModel):
    def __init__(
        ...
        self.module = PeaksTF2GeneExpressionPoisson_Jc(
            n_peaks=self.n_peaks,
            peak_len=256,
            n_tfs=self.n_tfs,
            n_covariates=self.n_covariates,
